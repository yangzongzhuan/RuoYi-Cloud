<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['collect:website:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['collect:website:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['collect:website:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['collect:website:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="websiteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="站点链接" align="center" prop="url" width="200" >
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="站点链接" prop="url">
          <el-input v-model="form.url" placeholder="请输入站点链接" />
        </el-form-item>
      </el-form>
...
<script>
import { listWebsite, getWebsite, delWebsite, addWebsite, updateWebsite } from "@/api/collect/website";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('collect/website/export', {
        ...this.queryParams
